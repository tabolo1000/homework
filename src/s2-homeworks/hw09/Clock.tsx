...
function Clock() {
    ...
    const min:number = date.getMinutes(),
          ...
          weekDate: Intl.DateTimeFormat = new Intl.DateTimeFormat('en-US', {
              weekday: "long",
          }),
          monthDate:Intl.DateTimeFormat = new Intl.DateTimeFormat('en-US', {
              month: 'long',
          })
    function addZero(number: number):number | string {
